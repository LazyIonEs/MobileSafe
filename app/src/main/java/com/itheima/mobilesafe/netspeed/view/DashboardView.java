    ...
    private void draw() {
        for (int i = 0; i <= blackArc; i++){
            ...
            if (progress == 0) {
                ...
                blue_color = getResources().getColor(R.color.changeColor1);
            }else if (progress == 90){
                blue_color = getResources().getColor(R.color.changeColor2);
            }else if (progress == 135){
                blue_color = getResources().getColor(R.color.changeColor3);
            }else if (progress == 180){
                blue_color = getResources().getColor(R.color.changeColor4);
            }else if (progress == 225){
                blue_color = getResources().getColor(R.color.changeColor5);
            }else if (progress == 270){
                blue_color = getResources().getColor(R.color.changeColor6);
            }
            postInvalidate();//重新绘制
        }
    }
